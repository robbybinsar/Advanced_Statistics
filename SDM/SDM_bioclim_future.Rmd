...
bioclim.data <- list.files("~/My R/Advanced_Statistics/summerproject/species_modelling/future",pattern = "*.tif$", full.names = TRUE)
bioclim.data <- brick(bioclim.data[1])
...
# Write raster ONCE
```{r}
raster::writeRaster(predict.presence.historical, paste0("~/My R/Advanced_Statistics/summerproject/species_modelling/results/future/bioclim/future_presence_only.tif"), overwrite = TRUE)

raster::writeRaster(predict.presence.pseudo, paste0("~/My R/Advanced_Statistics/summerproject/species_modelling/results/future/bioclim/future_presence_absence.tif"), overwrite = TRUE)
```
...
raster::writeRaster(reclass_predict.presence.pseudo, paste0("~/My R/Advanced_Statistics/summerproject/species_modelling/results/future/bioclim/future_presence_absence_",stat_used,".tif"), overwrite = TRUE)

write.table(threshold_used, paste0("~/My R/Advanced_Statistics/summerproject/species_modelling/results/future/bioclim/threshold_",stat_used,"_",date_now,".txt"))
