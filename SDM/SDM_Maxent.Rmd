...
raster::writeRaster(px, paste0("~/My R/Advanced_Statistics/summerproject/species_modelling/results/maxent/predicted_maxent.tif"), overwrite = TRUE)
```
...
raster::writeRaster(predict_threshold, paste0("~/My R/Advanced_Statistics/summerproject/species_modelling/results/maxent/predicted_maxent_",stat_used,".tif"), overwrite = TRUE)

write.table(threshold_used, paste0("~/My R/Advanced_Statistics/summerproject/species_modelling/results/maxent/threshold_",stat_used,"_",date_now,".txt"))
