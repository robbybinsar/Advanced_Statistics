...
```{r}
df <- read.xlsx("C:/Users/robby/OneDrive - University of Leeds/MSc Biodiversity and Conservation/BIodiv and Cons skills/Class 4/T.xlsx")
kable(df)
dependent.var <- df[,1] #Column variabel dependent
independent.var <- df[,2]#Column variabel independent
satuan <- "(mg)"
df$Enzy <- factor(df$Enzy, levels = c(0,1), labels = c("without", "with"))
```
